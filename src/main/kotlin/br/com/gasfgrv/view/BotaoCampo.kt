...
import br.com.gasfgrv.model.CampoEvento
...
class BotaoCampo(private val campo: Campo) : JButton() {
    ...
    private fun aplicarEstiloAberto() {
        ...
        foreground = when (campo.quantidadeDeVizinhosMarcado) {
            1 -> COR_TXT_VERDE
            2 -> Color.BLUE
            3 -> Color.YELLOW
            4, 5, 6 -> Color.RED
        ...
        text = if (campo.quantidadeDeVizinhosMarcado > 0) campo.quantidadeDeVizinhosMarcado.toString() else ""
    }
